...
<head>
    ...
    <link rel="stylesheet" href="/resources/stylesheets/product/add.css">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            <span hidden>이름</span>
                            <input autofocus class="object-text" maxlength="100" name="name" type="text">
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <label>
                            <span hidden>가격</span>
                            <input class="object-text" maxlength="10" name="price" type="number">
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <label>
                            ...
                            <input class="object-text" name="image" type="file">
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <label>
                            ...
                            <select class="object-text" multiple name="options"></select>
                        </label>
                        <label>
                            ...
                            <label>
                                <span hidden>입고량</span>
                                <input class="object-text" maxlength="10" name="colorPremium" placeholder="수량" type="number">
                            </label>
